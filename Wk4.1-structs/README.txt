...
prototype.c - Shows using prototypes so compiler can verify
    ...
    uhoh2.c - Uses a struct to show when Unix time runs out.


Subdirectories:

    structs - Files showing writing a structure to a file and
              then reading it back into memory.

   homework - The homework for this week's exercises.
